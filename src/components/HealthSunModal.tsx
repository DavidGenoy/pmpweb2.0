      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            // Clean modal sizing, max-h limits on mobile for internal scrolling. using svh to respect iOS Safari toolbar
            className="relative w-full max-w-[600px] max-h-[92svh] md:max-h-[90vh] bg-primary-900 rounded-3xl sm:rounded-[2rem] shadow-2xl border border-white/10 flex flex-col z-10 shadow-[0_20px_60px_-15px_rgba(0,168,150,0.2)]"
          >
            {/* Close Button - positioned safely */}
            <button
              onClick={dismissModal}
              className="absolute top-3 right-3 sm:top-5 sm:right-5 p-2.5 bg-primary-900 border border-white/20 hover:bg-white/10 rounded-full text-white/80 hover:text-white shadow-xl transition-all z-30 group"
            ...
            <div className="p-5 sm:p-8 md:p-10 flex flex-col flex-1 min-h-0 overflow-y-auto overscroll-contain items-center text-center">
              
              {/* HealthSun Logo */}
              <div className="w-24 sm:w-40 md:w-48 mb-4 sm:mb-8 shrink-0 bg-white/5 p-3 sm:p-4 rounded-2xl border border-white/10">
                <img 
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-accent-500/10 border border-accent-500/20 rounded-full mb-3 sm:mb-4 shrink-0">
                <div className="w-1.5 h-1.5 rounded-full bg-accent-400" />
                <span className="text-accent-400 text-xs font-bold tracking-wide uppercase">Patient Notice</span>
              </div>
              
              <h2 id="healthsun-modal-title" className="text-xl sm:text-2xl md:text-3xl font-serif text-white mb-3 sm:mb-4 leading-tight shrink-0">
                Important Notice for HealthSun Patients
              </h2>
              
              <p className="text-white/80 text-sm sm:text-base md:text-lg mb-5 sm:mb-8 shrink-0 max-w-lg">
                As of <strong>July 31st</strong>, Primary Medical Physicians will no longer accept HealthSun Health Plans.
              </p>

              <div className="w-full bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 mb-5 sm:mb-8 text-left space-y-4 sm:space-y-6 shrink-0">
                <p className="text-white/70 text-xs sm:text-sm font-medium text-center mb-2 sm:mb-0">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-white/10">
                  <div className="flex flex-col items-center w-full py-4 sm:py-2">
              ...
              <div className="mt-6 sm:mt-8 shrink-0 w-full flex justify-center">
                <button
                  onClick={dismissModal}
